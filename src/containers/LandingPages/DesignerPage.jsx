...
export default class DesignerPage extends Component {
  ...
  render() {
    ...
    return (
      <div className={style.designerPage}>
        <div className={style.landingFlex}>
          <div className={style.designerTextPosition}>
            <Text className={style.text}>
              Who will ensure you're savings are maxed out,<br/>rather than a sales commission? Lance will.<br/><br/>
              Do it yourself with Sunnova's ease to use<br/>technology, or hire someone to do it for you.
            </Text>
          </div>
          <AnimatedBox className={style.installerBox} show={true} width={"76%"} height={'auto'}>
            <div style={{padding: '0.3vw 1vw', position: 'relative'}}>
              <Text big bold className={style.text}>Lance Rumford - Top 5% designer</Text>
              <Text className={style.text}>“You’ll save a ton on electricity for sure!”</Text>
              <Text className={style.reviewsText}>26 reviews</Text>
              <img className={style.reviewRating} src="/images/4-25-rating.svg"/>
            </div>
          </AnimatedBox>
        </div>
      </div>
