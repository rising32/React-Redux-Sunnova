...
export default class SummaryGlass extends Component {
  static propTypes = {
  ...
  goMenu = () => {
    console.log(this.props.user, this.props.user.social);
    if (!this.props.user || this.props.user.social) {
      this.closeHelp();
      this.props.toggle('LoginBoxGlass');
      return;
      ...
      <div className="glass-widget-base" style={{
        ...
        <div className="section" style={{
          ...
          <div className="text-link clickable user-row first" style={{paddingTop: 50}}>
              Viewing a project’s summary requires
          </div>
          <div className="text-link clickable user-row">
            1. being logged in to Sunnova Pro as a Sunnova Ernergy Consultant, and
          </div>
